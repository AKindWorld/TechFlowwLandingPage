        ...
        <div ref={ref3} className={`m-4 p-4 sm:m-8 sm:p-8 ${isVisible3 ? "opacity-100" : "opacity-0"} transition-opacity duration-700 ease-in`}>
            ...
            <div className='mt-8 grid grid-cols-2 sm:grid-cols-3 sm:gap-6 lg:grid-cols-9 lg:gap-4 lg:m-16 md:p-16 pt-0'>
                <a className="group block text-center hover:fill-[#61DBFB] pt-4 pb-4 md:p-0" target='_blank' rel="noopener noreferrer">
                    <img className="m-auto group-hover:animate-jump-in animate-once animate-duration-300" src="/static/assets/Icons/ReactIcon.svg" alt="React Logo"/>
                ...
                <a className="group block text-center hover:fill-[#417e38] pt-4 pb-4 md:p-0" target='_blank' rel="noopener noreferrer">
                    <img className="m-auto group-hover:animate-jump-in animate-once animate-duration-300 dark:invert" src="/static/assets/Icons/NodeJSIcon.svg" alt="NodeJS Logo"/>
                ...
                <a className="group block text-center hover:fill-[#242938] pt-4 pb-4 md:p-0" target='_blank' rel="noopener noreferrer">
                    <img className="m-auto group-hover:animate-jump-in animate-once animate-duration-300" src="/static/assets/Icons/ExpressJSIcon.svg" alt="ExpressJS Logo"/>
                ...
                <a className="group block text-center hover:fill-[#000] pt-4 pb-4 md:p-0" target='_blank' rel="noopener noreferrer">
                    <img className="m-auto group-hover:animate-jump-in animate-once animate-duration-300" src="/static/assets/Icons/AngularIcon.svg" alt="Angular Logo"/>
                ...
                <a className="group block text-center hover:fill-[#EA2D2E] pt-4 pb-4 md:p-0" target='_blank' rel="noopener noreferrer">
                    <img className="m-auto group-hover:animate-jump-in animate-once animate-duration-300" src="/static/assets/Icons/JavaIcon.svg" alt="Java Logo"/>
                ...
                <a className="group block text-center hover:fill-[#FF9900] pt-4 pb-4 md:p-0" target='_blank' rel="noopener noreferrer">
                    <img className="m-auto group-hover:animate-jump-in animate-once animate-duration-300" src="/static/assets/Icons/AWSIcon.svg" alt="AWS Logo"/>
                ...
                <a className="group block text-center hover:fill-[#FFE052] pt-4 pb-4 md:p-0" target='_blank' rel="noopener noreferrer">
                    <img className="m-auto group-hover:animate-jump-in animate-once animate-duration-300" src="/static/assets/Icons/PythonIcon.svg" alt="Python Logo"/>
                ...
                <a className="group block text-center hover:fill-[#2396ED] pt-4 pb-4 md:p-0" target='_blank' rel="noopener noreferrer">
                    <img className="m-auto group-hover:animate-jump-in animate-once animate-duration-300" src="/static/assets/Icons/DockerIcon.svg" alt="Docker Logo"/>
                ...
                <a className="group block text-center hover:fill-[#E6AD10] pt-4 pb-4 md:p-0" target='_blank' rel="noopener noreferrer">
                    <img className="m-auto group-hover:animate-jump-in animate-once animate-duration-300" src="/static/assets/Icons/PowerBiIcon.svg" alt="PowerBI Logo"/>

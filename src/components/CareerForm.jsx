                            ...
                            <form onSubmit={handleSubmit} target="_self" className="space-y-4">
                                ...
                                <fieldset>
                                    <div className="captcha-field text-sm w-full">
                                        ...
                                        <input placeholder={`Between ${num1 + num2 - Math.floor(Math.random() * 3)} - ${num1 + num2 + 2} `} type="number" value={userInput} onChange={handleInputChange} className="peer w-max rounded-lg mr-2 border-gray-200 p-3 text-sm dark:bg-[#181825]" />
                                        <button type="button" onClick={handleValidateClick} className="mx-2 ml-0 p-3 px-4 bg-slate-300 dark:bg-[#D4C0FF] dark:text-black">Validate</button>
                                        {validationError && (
